...
Same six steps as rag_pipeline.py, but the input is data/sample.pdf,
loaded with PyPDFLoader instead of TextLoader. Unlike TextLoader,
PyPDFLoader returns one Document per page (each with a "page" number
in metadata), so step 1 already produces multiple documents here.
...
DOCUMENT_PATH = PROJECT_ROOT / "data" / "sample.pdf"
CHUNK_SIZE = 500
CHUNK_OVERLAP = 50
EMBEDDING_MODEL = "sentence-transformers/all-MiniLM-L6-v2"
PERSIST_DIRECTORY = PROJECT_ROOT / "db" / "pdf"
