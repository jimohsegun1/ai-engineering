...
Fetches a live web page over HTTP and parses it into a Document with
BeautifulSoup — the only loader in this folder that depends on internet
access, since every other one reads from local files.
"""
...
os.environ.setdefault("USER_AGENT", "ai-engineering-learning-project/1.0")
...
PERSIST_DIRECTORY = PROJECT_ROOT / "db" / "loader_web"
...
# --- Step 1: Load document (WebBaseLoader) ---
print_step(1, "Load document (WebBaseLoader)")
