...
Unlike TextLoader, this returns one Document per PDF page (each carrying a
`page` number in its metadata) instead of a single Document for the whole file.
"""
...
PERSIST_DIRECTORY = PROJECT_ROOT / "db" / "loader_pdf"
...
# --- Step 1: Load document (PyPDFLoader) ---
print_step(1, "Load document (PyPDFLoader)")
