...
Loads a single plain-text file as one Document. The baseline every other
loader in this folder gets compared against.
"""
...
PERSIST_DIRECTORY = PROJECT_ROOT / "db" / "loader_text"
...
# --- Step 1: Load document (TextLoader) ---
print_step(1, "Load document (TextLoader)")
